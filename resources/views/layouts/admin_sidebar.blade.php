@php
    $navItems = [
        ...
        ['route' => 'admin.verification', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'label' => 'Content Verification', 'isActive' => (request()->routeIs('admin.verification'))],
        ['route' => 'admin.users', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H9a2 2 0 01-2-2v-1a4 4 0 014-4h2a4 4 0 014 4v1a2 2 0 01-2 2z', 'label' => 'User Management', 'isActive' => (request()->routeIs('admin.users'))],
        ['route' => 'admin.masterdata', 'icon' => 'M4 7v10m-4 0h16M4 7h16M4 7h16', 'label' => 'Data Master', 'isActive' => (request()->routeIs('admin.masterdata'))],
        ['route' => 'admin.reports', 'icon' => 'M9 17v-2m3 2v-4m3 4v-6m2 0H7m12 0a2 2 0 100-4 2 2 0 000 4z', 'label' => 'System Reports', 'isActive' => (request()->routeIs('admin.reports'))],
        ['route' => 'admin.settings', 'icon' => 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37a1.724 1.724 0 002.572-1.065z', 'label' => 'Settings', 'isActive' => (request()->routeIs('admin.settings'))],
    ];
@endphp
