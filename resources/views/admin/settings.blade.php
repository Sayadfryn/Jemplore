...
@section('content')
    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data"> 
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 mb-8">
            <h3 class="text-xl font-semibold text-gray-800 mb-6">Why Visit Section</h3>

            <div class="space-y-6">
                <div>
                    <label for="why_visit_title" class="block text-sm font-medium text-gray-700 mb-1">Section Title</label>
                ...
                <div>
                    <label for="why_visit_description" class="block text-sm font-medium text-gray-700 mb-1">Section Description</label>
